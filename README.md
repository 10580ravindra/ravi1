...
-----------------------------
begin 
for i in (select h.* from admin.SERVICERATEsvf_dtl h,ip.servicesvf d where medicineid=d.serviceid AND H.MEDICINEID !='S0004426')
loop 
delete from ip.servicesrtdtlsvf_copy where socid in ('IND00001','IND00015','IND00053') and  serviceid=i.medicineid;
insert into ip.servicesrtdtlsvf_copy select i.medicineid ,roomtypeid ,
CASE WHEN roomtypeid='CAT00000' THEN ROUND(i.SERVICERATE ,-1)  --OPD
WHEN roomtypeid='CAT00001' THEN ROUND(i.SERVICERATE*1.2,-1)        --SHARING WARD
WHEN roomtypeid='CAT00003' THEN ROUND(i.SERVICERATE*1.3 ,-1)       --PRIVATE
WHEN roomtypeid='CAT00004' THEN ROUND(i.SERVICERATE *1.3,-1)       --DELUXE
WHEN roomtypeid='CAT00005' THEN ROUND(i.SERVICERATE *1.3 ,-1)      --ICU
WHEN roomtypeid='CAT00007' THEN ROUND(i.SERVICERATE*1.1 ,-1)       --ER
WHEN roomtypeid='CAT00008' THEN ROUND(i.SERVICERATE*1.1 ,-1)       --GENERAL WARD
WHEN roomtypeid='CAT00009' THEN ROUND(i.SERVICERATE*1.2 ,-1)       --ECONOMY ROOM
WHEN roomtypeid='CAT00012' THEN ROUND(i.SERVICERATE*1.3 ,-1)       --DELUXE SUITE
WHEN roomtypeid='CAT00013' THEN ROUND(i.SERVICERATE*1.3 ,-1)       --Step Down ICU
END ,DOCSHAREPER ,DOCSHAREAMT ,SOCID ,TESTINOROUT ,SNO ,PRVRT ,USERNM ,USERID ,
RIID ,DENTALLABCHARGES ,RATESAI ,CHECKACT ,PCRATE ,PCVALUE ,1 ,TILFLG ,SCODE_SER ,DEPARTMENT_SER ,
COMPANYCODE ,COMPANYNM ,MODRATE ,MODRATE4  from (select * from IP.servicesrtdtlsvf
where socid in ('IND00001','IND00015','IND00053')and serviceid='S0004426');
end loop;
end;
ROL AND ROQ UPDATE
------------------------
